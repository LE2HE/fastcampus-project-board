...
class ArticleServiceTest {
    ...
    @DisplayName("검색어와 없이 게시글을 해시태그로 검색하면, 빈 페이지를 반환")
    @Test
    ...
    @DisplayName("게시글을 해시태그로 검색하면, 게시글 페이지를 반환")
    @Test
    ...
    @DisplayName("게시글 정보를 입력하면, 본문에서 해시태그 정보를 추출하여 해시태그 정보가 포함된 게시글을 생성")
    @Test
    ...
    void givenNonexistentArticleInfo_whenUpdatingArticle_thenLogsWarningAndDoesNothing() {
        // given
        ArticleDto dto = createArticleDto("타이틀", "내용");
